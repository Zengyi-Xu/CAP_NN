function [k,y,E,W,V,X_v] = LMS_volterra_1DownS_Testnan(taps_LMS,u_LMS,taps_volterra,u_volterra,numofTs,Rxdata,Txdata)
...
for i=1:1
    ...
    while n<=ntr
        ...
        y(nn) = W*X_LMS+VV;             %  compute and assign current output signal sample
...
% k=[Rxdata(1:(compensation-1)).' k]; %²¹³¥³éÍ·ËðÊ§
